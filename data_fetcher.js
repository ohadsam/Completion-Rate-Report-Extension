 ...
 */
export async function postTrendDataDrillDown(params, entityType, start, end, releaseID, sprintID, milestoneID, teams, filterOnlyDoneItems) {
    ...
    let doneItemsFilter = filterOnlyDoneItems ? ';(phase={(metaphase={id=\'metaphase.work_item.done\'})})' : '';
    const response = await fetch(`${params.octane_url}/internal-api/shared_spaces/${params.shared_space}/workspaces/${params.workspace}/trend/drill_down`, {
        ...
        body: JSON.stringify({
            ...
            'sets': `[{\"query\":\"(${entityTypeQueryValue}(release={id=${releaseID}})${sprintQueryValue}${milestoneQueryValue}${teamQueryValue}${doneItemsFilter})\",\"groupBy\":false,\"key\":\"singleLine\",\"overrideField\":null}]`,
